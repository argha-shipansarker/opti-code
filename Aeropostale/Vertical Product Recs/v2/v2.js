...
utils.observeSelector('#pdp-ymal-recommendations .search-result-items .grid-tile', function (ymal_recommendations_tile) {
    ymal_recommendations_tile.style.setProperty("width", "calc(33% - 1rem)", "important");
});

utils.observeSelector('.cart-recommendations .search-result-items .grid-tile', function (recommendations_tile) {
    recommendations_tile.style.setProperty("width", "calc(33% - 1rem)", "important");
});
