...
utils.observeSelector('.product-details-page .addToCart', function (add_to_cart_btn) {
    ...
    utils.observeSelector('.product-details-page .lowest-recent-price-block', function (lowest_price_block) {
        ...
        const observer = new MutationObserver((mutations) => {
            mutations.forEach((mutation) => {
                if (mutation.type === 'characterData' || mutation.type === 'childList') {
                    ...
                    lowest_price_block.querySelectorAll('.opti-new-text').forEach(function (single_new_text) {
                        if (new_text.includes('<span')) {
                            single_new_text.innerHTML = new_text;
                        } else {
                            single_new_text.innerText = new_text;
                        }
                    });
        ...
        if (lowest_price_block.querySelector('.price')) {
            observer.observe(lowest_price_block.querySelector('.price'), { childList: true, characterData: true, subtree: true });
        }
