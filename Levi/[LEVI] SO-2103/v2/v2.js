...
function handleTranslation(product_type, copy_name) {
    ...
    let translations = {
        EN: {
            ...
            "spring-new-arrivals": { head: "SPRING NEW ARRIVALS", sub: "Fresh styles, new icons and best selling fits to get you ready for a new season.", men_cta: "SHOP MEN", women_cta: "SHOP WOMEN", dd_label: "Select Category" },
        ...
        DE: {
            ...
            "spring-new-arrivals": { head: "FRISCH FÜR DEN FRÜHLING", sub: "Erfrischend neue Style-Ikonen und die meistverkauften Modelle, mit denen sich die neue Saison kaum erwarten lässt.", men_cta: "HERREN", women_cta: "DAMEN", dd_label: "Kategorie auswählen" },
        ...
        FR: {
            ...
            "spring-new-arrivals": { head: "NOUVEAUTÉS PRINTANIÈRES", sub: "Des styles inédits, de nouvelles pépites et des fits de folie pour accueillir la nouvelle saison.", men_cta: "POUR LUI", women_cta: "POUR ELLE", dd_label: "Sélectionner une catégorie" },
        ...
        ES: {
            ...
            "spring-new-arrivals": { head: "NOVEDADES DE PRIMAVERA", sub: "Diseños frescos, nuevos iconos y los fits más vendidos para que lo tengas todo listo para la nueva temporada.", men_cta: "COMPRAR PARA ÉL", women_cta: "COMPRAR PARA ELLA", dd_label: "Seleccionar categoría" },
        ...
        IT: {
            ...
            "spring-new-arrivals": { head: "NUOVI ARRIVI DI PRIMAVERA", sub: "Modelli freschi freschi, nuove icone e i fit più venduti per prepararti a una nuova stagione.", men_cta: "ACQUISTA UOMO", women_cta: "ACQUISTA DONNA", dd_label: "Seleziona categoria" },
        ...
        NL: {
            ...
            "spring-new-arrivals": { head: "NIEUW BINNEN VOOR DE LENTE", sub: "Frisse modellen, nieuwe iconen en de best verkopende pasvormen om je klaar te maken voor een nieuw seizoen.", men_cta: "SHOP HEREN", women_cta: "SHOP DAMES", dd_label: "Selecteer categorie" },
