    ...
    utils.waitForElement('.adm-section:has(+#quote-summary)').then(function (home_car_van_section_wait) {
        utils.observeSelector('.adm-section:has(+#quote-summary)', function (home_car_van_section) {
            ...
            if (!JSON.parse(sessionStorage.getItem("is_car_removed"))) {
                ...
                if (!document.querySelector('.opti-text-carousel')) {
                                        ...
                                        <div class="slider-wrapper">
                                            <ul class="slider" style="transform: translate3d(0%, 0px, 0px); transition-duration: 500ms;">
                                                <style>
                                                    ...
                                                    @media (min-width: 368px) and (max-width: 383px) {
                                                        .opti-slide-data.mobile-view .opti-slide-content .description .heading span[data-test="add-car-van-banner-van-text"] {
                                                            font-size: 13px !important;
                                                        }
                    
                                                        .opti-slide-data.mobile-view.car .opti-slide-content .description .heading {
                                                            font-size: 15px;
                                                        }
                    
                                                        .opti-slide-data.mobile-view.car .opti-slide-content .description .heading span{
                                                            font-size: 16px;
                                                        }
                                                    }
                    
                                                    @media (min-width: 356px) and (max-width: 367px) {
                                                        .opti-slide-data.mobile-view .opti-slide-content .description .heading span[data-test="add-car-van-banner-van-text"] {
                                                            font-size: 12px !important;
                                                        }
                    
                                                        .opti-slide-data.mobile-view.van .opti-slide-content .description .heading span {
                                                            font-size: 17px;
                                                        }
                                                        ...
                                                        <div class="opti-slide-content">
                                                            <div class="description">
                                                                ...
                                                                <a class="opti-green-button"
                                                                    href='https://quote.admiral.com/Admiral/multicover/homedetails'
                                                ...
                                                <li class="slide" style="min-width: 100%;">
                                                    <div class="opti-slide-data desktop-view car">
                                                        <div class="opti-slide-content">
                                                            <div class="description">
                                                                ...
                                                                <a class="opti-green-button"
                                                                    href="https://quote.admiral.com/Admiral/addcar/car"
                                                                    style="text-transform: uppercase;">
                                                                    Add a Car
                                                                </a>
                                                            </div>
                                                    ...
                                                    <div class="opti-slide-data mobile-view car">
                                                        ...
                                                        <a class="opti-green-button" href="https://quote.admiral.com/Admiral/addcar/car"
                                                            style="text-transform: uppercase;">
                                                            Add a Car
                                                        </a>
                                                        <p class="footer-info">
                                                ...
                                                <li class="slide" style="min-width: 100%;">
                                                        ...
                                                        " />
                                                            <div class="description">
                                                                ...
                                                                <a class="opti-blue-button"
                                                                    href="https://quote.admiral.com/Admiral/addvan/van"
                                                                    style="text-transform: uppercase;">
                                                                    Add a Van
                                                                </a>
                                                    ...
                                                    <div class="opti-slide-data mobile-view van">
                                                        ...
                                                        <a class="opti-blue-button" href="https://quote.admiral.com/Admiral/addvan/van"
                                                            style="text-transform: uppercase;">
                                                            Add a Van
                                                        </a>
                                                        <div class="van-learn-more-cta" onclick="window.showVanModal()">
                    ...
                    if (document.querySelector('.adm-section:has(+#quote-summary) [data-test="multicover-promo-text"]')) {
                        ...
                        const dynamic_heading_home_desktop = document.querySelector('.adm-section:has(+#quote-summary) [data-test="multicover-alternate-text"]').cloneNode(true);
                        const dynamic_heading_home_mobile = document.querySelector('.adm-section:has(+#quote-summary) [data-test="multicover-alternate-text"]').cloneNode(true);
