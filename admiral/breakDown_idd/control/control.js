...
if (window.location.pathname == '/Admiral/ancillary/breakdown') {
    document.body.classList.add("ad409-control");
    utils.observeSelector('#breakdown-benefits-and-contents-header', function (headerSection) {
        ...
        cleanup('.opti-whats-included, #opti-whats-included-styles');
        if (!document.querySelector('.opti-whats-included')) {
            headerSection.insertAdjacentHTML("beforebegin", `<style id="opti-whats-included-styles">
