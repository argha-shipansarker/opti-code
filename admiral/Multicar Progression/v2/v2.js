...
utils.observeSelector('eui-navigation-bar', function (navigation_bar) {
    ...
    <style>
        ...
        .opti-multicar-progression .progression-container .step-number-text {
            font-size: 16px;
            line-height: 24px;
            font-weight: 700;
            color: #25469B;
        ...
        .opti-multicar-progression .progression-container .progress-bar {
            display: flex;
            gap: 4px;
        }
    ...
    <div class="progression-container">
        <p class="step-number-text">Step 1 of 5</p>
...
utils.observeSelector('eui-tier', function (cover_page) {
    if (document.querySelector('.opti-multicar-progression')) {
        ...
        const step_number_text = document.querySelector('.opti-multicar-progression .step-number-text');
        step_number_text.innerText = 'Step 1 of 5';
    }
});
...
utils.observeSelector('eui-vehicle-upgrades', function (upgrade_page) {
    if (document.querySelector('.opti-multicar-progression')) {
        ...
        const step_number_text = document.querySelector('.opti-multicar-progression .step-number-text');
        step_number_text.innerText = 'Step 2 of 5';
    }
});
...
utils.observeSelector('eui-quote eui-quote-summary', function (quote_page) {
    if (document.querySelector('.opti-multicar-progression')) {
        ...
        const step_number_text = document.querySelector('.opti-multicar-progression .step-number-text');
        step_number_text.innerText = 'Step 3 of 5';
    }
});
...
utils.observeSelector('eui-final-checks', function (checks_page) {
    if (document.querySelector('.opti-multicar-progression')) {
        ...
        const step_number_text = document.querySelector('.opti-multicar-progression .step-number-text');
        step_number_text.innerText = 'Step 4 of 5';
    }
});
...
utils.observeSelector('eui-gateway-s-payment', function (payment_page) {
    if (document.querySelector('.opti-multicar-progression')) {
        ...
        const step_number_text = document.querySelector('.opti-multicar-progression .step-number-text');
        step_number_text.innerText = 'Step 5 of 5';
    }
});
