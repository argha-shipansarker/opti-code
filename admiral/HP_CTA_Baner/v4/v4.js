...
utils.observeSelector('.hero-banner--electric-vehicle', function (hero_banner) {
    ...
    <style>
        .opti-new-home-banner {
            ...
            max-width: 1380px;
            height: 635px;
            background-image: url(https://cdn.optimizely.com/img/17941920996/069e0e872ca34f2d9762831f0ae105d9.png);
        ...
        .opti-new-home-banner .mobile-logo {
            display: none;
        }
        ...
        @media (max-width: 768px) {
            ...
            .opti-new-home-banner .opti-container .policy-section .policy img {
                display: none;
            }
        }
    </style>

    <img class="mobile-logo" src="https://cdn.optimizely.com/img/17941920996/eead0b621cda4d429982d67b9a71cafd.png"
        alt="mobile-logo">
