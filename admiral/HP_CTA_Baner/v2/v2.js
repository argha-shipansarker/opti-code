...
utils.observeSelector('.hero-banner--multicover-sleep', function (hero_banner) {
    ...
    <style>
        .opti-new-home-banner {
            ...
            max-width: 1440px;
            height: 543px;
            background-image: url(https://cdn.optimizely.com/img/17941920996/1963527884244f13a8f88e167fd23469.png);
    ...
    <div class="opti-container">
        <div class="banner-info">
            ...
            <img class="banner-logo mobile"
                src="https://cdn.optimizely.com/img/17941920996/0c40de1e723544d2889ff5de367d2ae8.png" alt="banner-logo">
