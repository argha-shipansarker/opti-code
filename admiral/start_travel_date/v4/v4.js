...
<div class="opti-info-box-container">
    ...
    <div class="opti-info-box">
        ...
        <p>If you would like immediate cancellation cover, you can select today's date as your start date. Alternatively, you can choose a later date but please be aware that cancellation cover won't start until that date.</p>
    </div>
</div>
                    `);
                }
